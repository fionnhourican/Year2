...
/**
 * The ClientApp class implements the interface App.
 * The ClientApp App is the main class that contains the main method to run the program.
...
public class ClientApp implements App {
    ...
    */
     ...
     * This method demonstrates  how the JavaVerse application works by simulating user actions.
     * It creates two people, adds them to the JavaVerse network, and makes one person follow the other.
     * creates an activity by the followed person, sends the activity to all followers, and then one of the
     * followers like the activity. The method then prints out information about the people, the activity, and
    ...
    private class FollowActivity implements Activity {
         ...
         * Makes the person requesting to follow, follow the person to be followed
    ...
    private class UnFollowActivity implements Activity {
         ...
         * Makes the person requesting to unfollow, unfollow the person to be unfollowed
    ...
    private class LikeActivity implements Activity {
        ...
        /**
         * The constructor LikeActivity creates a new instance of a LikeActivity object with the given post, poster, and liker.
         ...
         * @return CreateActivity - The post to be liked
         * @see Class LikeActivity
         * @see CreateActivity
         */
        ...
        /**
         * setPost method declared in class LikeActivity
    ...
    /**
     * The ShareActivity class implements the Activity interface.
     * The class represents a "Share" activity in a social network, where one person shares anothers post.
     * @see Activity
     */
    private class ShareActivity implements Activity {
        ...
        /**
         * The post requesting to be shared
         */
        private CreateActivity post;
        ...
        /**
         * getURI method declared in class ShareActivity
         * @return String - URI of the post to be liked
         * @see Class ShareActivity
         * @see Activity
         */
        ...
        /**
         * setURI method declared in class ShareActivity
         * @see Class ShareActivity
         */
        public void setURI() {
            this.uri = getPost().getURI();
        ...
        /**
         * getPost method declared in class ShareActivity
         * @return Person - The person who ownes the post
         * @see Class ShareActivity
         * @see Activity
         */
        ...
        /**
         * setPoster method declared in class ShareActivity
         * @param post - The post being shared
         * @see Class ShareActivity
         */
        public void setPost(CreateActivity post) {
            this.post = post;
        ...
        /**
         * getPoster method declared in class ShareActivity
         * @return Person - The person who ownes the post
         * @see Class ShareActivity
         * @see Activity
         */
        ...
        /**
         * getReposter method declared in class ShareActivity
         * @return Person - The person requesting to share the Post
         * @see Class ShareActivity
         * @see Activity
         */
        ...
        /**
         * setReposter method declared in class ShareActivity
         * @param person - The person requesting to share the Post
         * @see Class ShareActivity
         */
        ...
        /**
         * toSring method declared in class ShareActivity
         * @return String - reposter shred posts uri by poster
         * @see Class ShareActivity
         */
        @Override
        public String toString() {
     ...
     * The class represents a "Create activity" activity in a social network, where a person Creates a Post
     * @see Activity
     * @see StreamObject
     */
    private class CreateActivity extends StreamObject implements Activity {
         ...
         * audience, content, name, deleted, owner
         ...
         */
        public CreateActivity(String uri, Audience audience, String content, String name, boolean deleted, Person owner) {
            super(uri, audience, content, name, deleted);
            setOwner(owner);
            posted();
        }
         ...
         * @return String - post name by owner (Post URI)
         * @see Class CreateActivity
         */
        @Override
        public String toString(){
    ...
    private class DeleteActivity implements Activity {
        ...
        /**
         * unlike method declared in class DeleteActivity
    ...
    class Person {
        ...
        /**
         * The constructor Person creates a new instance of a Person object with the given uri, and name
         ...
         * Initilises Persons following Array
         * @see Class Person
         */
         ...
         * Adds a stream object to the user's liked Array
         ...
         * Adds a Post to the user's shared Array
    ...
    class StreamObject {
        ...
        /**
        * Constructs a new StreamObject with the specified URI, audience, content, name,
        ...
        */
        public StreamObject(String uri, Audience audience, String content, String name, boolean deleted) {
            setURI(uri);
         ...
         * Sets the published time to the date and time when created
         * @see Class StreamObject
         */ 
